  ...
  const teamMembers = [
    {
      ...
      description:
        "Visionary leader crafting digital solutions that empower businesses to thrive in the online world.",
      imgSrc: Gowthamaraj
    },
    {
      ...
      description:
        "Strategic innovator transforming ideas into impactful experiences, driving growth and success.",
    ...
    },
    {
      ...
      description:
        "Building robust foundations behind the scenes, ensuring our applications run smoothly and securely.",
      imgSrc: Gowthaam
    },
    {
      name: "Lingesh T",
      ...
      description:
        "Turning designs into reality, one pixel at a time, to create seamless user experiences.",
      imgSrc: Lingesh
    },
    {
      name: "Dhayananth E",
      ...
      description:
        "Connecting creativity with strategy to elevate brands and foster lasting relationships with clients.",
      imgSrc: Dhayananth
    },
    {
      ...
      description:
        "Your trusted ally in navigating challenges, delivering exceptional service and ensuring client satisfaction at every turn.",
      imgSrc: Aditya
    }
  ];
